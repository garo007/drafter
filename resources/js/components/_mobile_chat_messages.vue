<template>
    <div class="parent-of-all">
        ...
        <!--        </button>-->
        <!--        <div class="chat_points_line"></div>-->
        <!--        <button type="button" class="block_btn">-->
        <!--            Заблокировать-->
        <!--        </button>-->
        <!--        <div class="chat_points_line"></div>-->
        ...
        <div class="chat_filter_item" v-if="this.active_parent">
            <div class="chat_filter_input_svgs_wrapper">
                ...
                <!--                    <path d="M12 10.125L12.0001 20.25" stroke="#9B8E6C" stroke-linecap="round" stroke-linejoin="round"></path>-->
                <!--                    <path d="M12.0001 3.75L12 6.375" stroke="#9B8E6C" stroke-linecap="round" stroke-linejoin="round"></path>-->
                <!--                    <path d="M12 10.125C13.0355 10.125 13.875 9.28553 13.875 8.25C13.875 7.21447 13.0355 6.375 12 6.375C10.9645 6.375 10.125 7.21447 10.125 8.25C10.125 9.28553 10.9645 10.125 12 10.125Z" stroke="#9B8E6C" stroke-linecap="round" stroke-linejoin="round"></path>-->
                <!--                    <path d="M18.75 17.625L18.7501 20.25" stroke="#9B8E6C" stroke-linecap="round" stroke-linejoin="round"></path>-->
                <!--                    <path d="M18.7501 3.75L18.75 13.875" stroke="#9B8E6C" stroke-linecap="round" stroke-linejoin="round"></path>-->
                <!--                    <path d="M18.75 17.625C19.7855 17.625 20.625 16.7855 20.625 15.75C20.625 14.7145 19.7855 13.875 18.75 13.875C17.7145 13.875 16.875 14.7145 16.875 15.75C16.875 16.7855 17.7145 17.625 18.75 17.625Z" stroke="#9B8E6C" stroke-linecap="round" stroke-linejoin="round"></path>-->
                <!--                    <path d="M5.25006 14.625L5.25 20.25" stroke="#9B8E6C" stroke-linecap="round" stroke-linejoin="round"></path>-->
                <!--                    <path d="M5.25 3.75L5.25006 10.875" stroke="#9B8E6C" stroke-linecap="round" stroke-linejoin="round"></path>-->
                <!--                    <path d="M5.25 14.625C6.28554 14.625 7.125 13.7855 7.125 12.75C7.125 11.7145 6.28554 10.875 5.25 10.875C4.21447 10.875 3.375 11.7145 3.375 12.75C3.375 13.7855 4.21447 14.625 5.25 14.625Z" stroke="#9B8E6C" stroke-linecap="round" stroke-linejoin="round"></path>-->
                <!--                </svg>-->

                <!--            </div>-->
                <!--            <div class="chat_filter_svg_second">-->
                <!--                <svg width="19" height="18" viewBox="0 0 19 18" fill="none" xmlns="http://www.w3.org/2000/svg">-->
                <!--                    <path d="M0.945313 0.5H17.0545C17.1998 0.5 17.342 0.542205 17.4637 0.621485C17.5855 0.700766 17.6816 0.813708 17.7404 0.946585C17.7992 1.07946 17.8181 1.22655 17.7948 1.36998C17.7716 1.51341 17.7072 1.64699 17.6094 1.7545L11.4449 8.53545C11.3194 8.6735 11.2499 8.85338 11.2499 9.03995V14.3486C11.2499 14.4721 11.2194 14.5936 11.1612 14.7025C11.1029 14.8114 11.0187 14.9042 10.9159 14.9726L7.91592 16.9727C7.80297 17.048 7.6717 17.0912 7.53611 17.0977C7.40052 17.1043 7.26569 17.0739 7.14601 17.0099C7.02632 16.9458 6.92626 16.8505 6.8565 16.734C6.78674 16.6176 6.7499 16.4844 6.7499 16.3486V9.03996C6.7499 8.85338 6.68036 8.67351 6.55485 8.53545L0.390358 1.7545C0.29262 1.64699 0.228215 1.51341 0.204972 1.36998C0.181728 1.22655 0.200647 1.07946 0.259427 0.946585C0.318208 0.813708 0.41432 0.700766 0.536083 0.621485C0.657845 0.542205 0.800015 0.5 0.945313 0.5V0.5Z" stroke="#E5D6A0" stroke-linecap="round" stroke-linejoin="round"></path>-->
                <!--                </svg>-->

                <!--            </div>-->
            </div>
            <div class="chat_filter_new_messages_item" @click.prevent="openChat(friend)"  v-for="friend in searchHandler" :key="friend.id">
                <div class="chat_filter_message_img_text_wrapper">
                    ...
                    <div class="chat_filter_message_img_text_title_wrapper">
                        ...
                        <div v-if="friend.session.lastMessageFile != '' " style="max-width: 13px">
                        ...
                        <p class="chat_filter_message_img_text" v-if=" friend.session && friend.session.lastMessage">{{ friend.session.lastMessage }}</p>
                        <p class="chat_filter_message_img_text" v-else>{{ "" }}</p>
                    </div>
                </div>
                <div class="chat_filter_message_date">
                    <div class="chat_filter_new_messages_quantity" v-if="friend.session && friend.session.unreadCount > 0">
                        <p class="new_messages_quantity" >{{friend.session.unreadCount ? friend.session.unreadCount :''}}</p>
                    </div>
            ...
            <div class="chat_filter_line"></div>
        </div>
        <div v-for="friend in searchHandler" :key="friend.id" v-if="friend.session && friend.session.open" class="chat_messages_parent">
            <ChatFormMobile
                v-if="friend.session.open"
                @close="close(friend)"
                :friend="friend"
                @isTyping="ChangeT($event)"
                @active_parent="active_parent_event($event)"
            ></ChatFormMobile>
        </div>
    </div>
</template>
...
<script>
import ChatFormMobile from "./_mobile_chat_form";
export default {
    data() {
        return {
            friends: [],
